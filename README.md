...
[中文文档](https://zread.ai/s1545151561/hubproxy)

[English](https://deepwiki.com/s1545151561/hubproxy)
...
```bash
curl -fsSL https://raw.githubusercontent.com/s1545151561/hubproxy/main/install.sh | sh
```
...
# ghcr加速
docker pull yourdomain.com/ghcr.io/s1545151561/hubproxy
...
# 加速下载仓库
git clone https://yourdomain.com/https://github.com/s1545151561/hubproxy.git
```
...
> 对于使用nginx反代的用户，Github加速提示`无效输入`的问题可以参见[issues/62](https://github.com/s1545151561/hubproxy/issues/62#issuecomment-3219572440)
...
## Star 趋势
[![Star 趋势](https://starchart.cc/s1545151561/hubproxy.svg?variant=adaptive)](https://starchart.cc/s1545151561/hubproxy)
